...
public class CalendarGridViewAdapter extends BaseAdapter
{
    ...
    private Calendar calStartDate = Calendar.getInstance();// 当前显示的日其
    private Calendar calSelected = Calendar.getInstance(); // 选择的日其
    ...
    {
        calStartDate.set(Calendar.DATE, 1); // 设置成当月
